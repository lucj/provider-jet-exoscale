...
import (
	...
	v1alpha1 "github.com/lucj/provider-jet-exoscale/apis/securitygrouprule/v1alpha1"
)
...
func Setup(mgr ctrl.Manager, l logging.Logger, rl workqueue.RateLimiter, s terraform.SetupFn, ws *terraform.WorkspaceStore, cfg *tjconfig.Provider, concurrency int) error {
	...
	r := managed.NewReconciler(mgr,
		...
		managed.WithExternalConnecter(tjcontroller.NewConnector(mgr.GetClient(), ws, s, cfg.Resources["exoscale_security_group_rule"])),
