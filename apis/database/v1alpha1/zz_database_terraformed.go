...
func (mg *Database) GetTerraformResourceType() string {
	return "exoscale_database"
}

// GetConnectionDetailsMapping for this Database
func (tr *Database) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"mysql[*].admin_password": "spec.forProvider.mysql[*].adminPasswordSecretRef", "pg[*].admin_password": "spec.forProvider.pg[*].adminPasswordSecretRef", "uri": "status.atProvider.uri"}
}
