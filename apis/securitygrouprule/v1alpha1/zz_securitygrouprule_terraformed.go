...
func (mg *SecurityGroupRule) GetTerraformResourceType() string {
	return "exoscale_security_group_rule"
}
...
func (tr *SecurityGroupRule) LateInitialize(attrs []byte) (bool, error) {
	...
	opts = append(opts, resource.WithNameFilter("SecurityGroup"))
	opts = append(opts, resource.WithNameFilter("SecurityGroupID"))
	opts = append(opts, resource.WithNameFilter("UserSecurityGroup"))
	opts = append(opts, resource.WithNameFilter("UserSecurityGroupID"))
